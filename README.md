...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/mssql-django-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mssql-django-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add mssql-django
# for installing globally
pixi global install mssql-django
```
...
It is possible to list all of the versions of `mssql-django` available on your platform:
...
```
pixi search mssql-django --channel conda-forge
```
